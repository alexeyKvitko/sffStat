...
public class SixBallSet extends BaseComponent {
    ...
    public ColorBallSelectListener mListener;
    ...
    public void setColorBallSelectListener(ColorBallSelectListener listener) {
        mListener = listener;
    }
    ...
    public interface ColorBallSelectListener {
        void onColorBallSelect(ColorBall colorBall);
    }
}
